...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="thisForm" name="thisForm" action="daily_att.php" method="post">
                    <div class="row" style="padding-bottom:15px;">
                        <div class="form-group">
                            <div class="col-md-3">
                                <label class="col-form-label">Attendance Date <span class="err">*</span></label>
                                <input type="date" class="form-control" name="att_date" id="att_date" title="Select the Date" value="<?php echo $do_date; ?>" autofocus="autofocus" />
                            </div>
                            <div class="col-md-3">
                                <label class="col-form-label">Day Order</label>
                                <input type="text" class="form-control" name="dayorder" id="dayorder" placeholder="Enter the Dayorder" title="Enter the Dayorder" value="" readonly>
                            </div>
                            <div class="col-md-4">
...
$('#btn_add').click(function(){
    if(document.thisForm.att_date.value == ""){ 
        swal({
            title: "Please select the attendance date..!",
